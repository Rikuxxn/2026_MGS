...
{
	return D3DXVECTOR2(static_cast<float>(m_CurrentState.lX), static_cast<float>(m_CurrentState.lY));
}
//===============================================
// マウスの過去の移動量取得処理
//===============================================
...
{
	return D3DXVECTOR2(static_cast<float>(m_PrevState.lX), static_cast<float>(m_PrevState.lY));
}
//===============================================
// マウスのホイールの取得
//===============================================
